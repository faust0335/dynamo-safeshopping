...
/**
 * 
 * This class initiates a graphical user interface to manipulate the CliSeAu nodes
 * 
 * @author Xu, Yinhua
 *
 */
...
class CliSeAuFrame extends JFrame {
	 ...
	 * the buttons to click to initialize a CliSeAu service and add CliSeAu nodes
	 * 
	 * @author Xu, Yinhua
	 *
	 */
	class CliSeAuPanel extends JPanel {	
		...
		/**
		 * The action starts one more CliSeAu service on the basis of an available
		 * ICAP server and the other existing CliSeAu node(s).
		 * 
		 * @author Chen, Yiqun
		 *
		 */
